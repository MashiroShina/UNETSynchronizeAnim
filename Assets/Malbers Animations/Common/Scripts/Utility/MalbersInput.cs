...
namespace MalbersAnimations
{
    ...
    public class MalbersInput : NetworkBehaviour
    {
        [SyncVar]
        private float  h1;
        ...
        [Command]
        public void CmdSendServerPos(float h, float v)
        {
             h1 = h;
            v1 = v;
        }
        ...
        [Command]
        public void CmdSendServerPos2(Vector3 pos, Quaternion rotate)
        {
            v3_PlayerPos = pos;
        ...
        void Update()
        {
            ...
            if (!hasAuthority)
            {
                ...
                character.Move(new Vector3(v1, 0,h1));
            ...
            CmdSendServerPos(Input.GetAxis("Vertical"), Input.GetAxis("Horizontal"));
            CmdSendServerPos2(transform.position, transform.rotation);
