...
public class CreateMesh : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Vector3[] vertices = new Vector3[]
        {
            ...
            //back face// The back of the special drawing to the front ,so we antiClockwise get bake face
            vertLeftTopBack,//left top back, 4
            vertRightTopBack,//right top back, 5
            new Vector3(-1,-1,-1),//left bottom back, 6
            new Vector3(1,-1,-1),//right bottom back, 7
